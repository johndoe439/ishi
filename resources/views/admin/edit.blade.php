<x-app-layout>
            ...
            <div class="col-span-full lg:col-span-8">
                <form action="{{ route('quotes.update', $quote) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <a href="{{ route('dashboard') }}" class="btn btn-secondary flex-center gap-2 px-6">
                        ...
                        <!-- Quote Summary & Image Upload moved inside the form (directly after opening <form>) -->
                        <div
                            class="bg-white dark:bg-dark-card rounded-xl shadow-sm border border-gray-100 dark:border-dark-border overflow-hidden mb-6 lg:hidden">
                            <!-- Visible only on mobile (lg:hidden) to avoid duplication on desktop -->
                            <div class="p-6 border-b border-gray-200 dark:border-dark-border">
                                ...
                                <div class="space-y-4">
                                    <div
                                        ...
                                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Tracking
                                            ID</span>
                                        <code
                                    ...
                                    <div
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            <option value="Pending"
                                                {{ old('status', $quote->status) == 'Pending' ? 'selected' : '' }}>
                                                Pending
                                            </option>
                                            <option value="In Transit"
                                                {{ old('status', $quote->status) == 'In Transit' ? 'selected' : '' }}>In
                                                Transit
                                            </option>
                                            <option value="Delivered"
                                                {{ old('status', $quote->status) == 'Delivered' ? 'selected' : '' }}>
                                                Delivered
                                            </option>
                                            <option value="Canceled"
                                                {{ old('status', $quote->status) == 'Canceled' ? 'selected' : '' }}>
                                                Canceled
                                            </option>
                                        </select>
                                        @error('status')
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    const container = document.querySelectorAll(
                        `#imagePreview .group/image-${index}`); // Select both previews
    ...
    <input type="hidden" name="remove_image_${index}" value="0">
...
`;
        ...
        function removeImage(index) {
            ...
            const containers = document.querySelectorAll(`#imagePreview .group/image-${index}`);
            ...
            <label for="image_${index}" class="w-full h-20 bg-gray-100 dark:bg-dark-card-two rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-dark-border-two text-gray-400 hover:bg-gray-50 dark:hover:bg-dark-card-two/50 transition-colors cursor-pointer">
                <i class="ri-camera-add-line text-xl"></i>
                <input type="hidden" name="remove_image_${index}" value="1">
